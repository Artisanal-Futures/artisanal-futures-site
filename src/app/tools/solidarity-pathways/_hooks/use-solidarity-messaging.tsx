...
import type { Member } from '../_validators/types.wip'
import type { Channel } from '~/app/tools/solidarity-pathways/_validators/types.wip'
import { useUrlParams } from '~/hooks/use-url-params'
import { notificationService } from '~/services/notification'
import { api } from '~/trpc/react'
import { useMessageChannelStore } from '../_stores/use-message-store'
...
export const useSolidarityMessaging = () => {
  ...
  const setActiveChannelById = (id: string | null) => {
    ...
    const channel = isUserAllowedToSaveToDepot ? checkIfChannelExists(id) : null
