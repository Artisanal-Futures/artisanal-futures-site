...
import {
  ArtisanSignupFormProvider,
  useArtisanSignup,
} from "../../_components/artisan-signup-form-provider";
  ...
  return (
    <div className="bg-background flex min-h-svh flex-col">
      ...
      <>
        ...
        {currentStep === 2 && <ArtisanProfileStep />}
      </>
    </div>
  );
}
...
export function WizardClient({ initialCode }: WizardClientProps) {
  return (
    <ArtisanSignupFormProvider initialCode={initialCode}>
      <WizardContent />
    </ArtisanSignupFormProvider>
  );
}
