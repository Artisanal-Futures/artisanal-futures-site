  ...
  return (
    <>
      ...
      <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        The &quot;big picture&quot; goal is to replace the extractive economy of
        big corporations, who put the lion&apos;s share in their own pockets,
        with a community-based economy that returns value to those who generate
        it. For businesses, the Artisanal Futures platform provides
        collaboration tools: for example, linking local supply chains such as
        farms and restaurants, or sharing access to AI or other technologies.
        For the public, it provides a marketplace where consumers are buying
        locally, saving money by buying in bulk, sharing knowledge, and engaging
        in other civic activities that might improve education and environments
      ...
      <ol className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          Upon signing up with your valid email address, you will be directed to
          an onboarding page where you fill in details about your business.
        </li>
        <li>
          Once you set up your shop and your survey is complete, you will be set
          up on the platform. Note you do need to do both in order to get
          featured. If you are unable to do so at that time, you can always
          continue in your profile.
        </li>
        <li>
          You are encouraged to participate in the community forum and interact
          with the platform browsers through other artisans&apos; product
          offerings.
        </li>
      </ol>
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>Any disputes should be resolved amicably within the community.</li>
      </ul>
