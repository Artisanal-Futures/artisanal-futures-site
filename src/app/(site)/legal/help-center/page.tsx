  ...
  return (
    <article className="prose lg:prose-xl">
      ...
      <p>
        ...
        public park. We, too, are a shared community resource — a place to share
      ...
      <p>
        The conversations we have here set the tone for every new arrival. Help
        us influence the future of this community by choosing to engage in
        discussions that make this forum an interesting place to be — and
      ...
      <p>
        ...
        But so are you. With your help, moderators can be community
      ...
      <p>
        ...
        everyone&apos;s time. Just flag it. If enough flags accrue, action will
        be taken, either automatically or by moderator intervention.
      </p>
      <p>
      ...
      <p>
        This is a public forum, and search engines index these discussions. Keep
      ...
      <p>
        ...
        work here, open a new topic in the site feedback category and let&apos;s
        discuss! If there&apos;s a critical or urgent issue that can&apos;t be
        handled by a meta topic or flag, contact us via the staff page.
      </p>
      <h5 id="terms-of-service">Terms of Service</h5>
      <p>
        Yes, legalese is boring, but we must protect ourselves – and by
        extension, you and your data – against unfriendly folks. We have a Terms
        of Service describing your (and our) behavior and rights related to
        content, privacy, and laws. To use this service, you must agree to abide
        by our TOS.
      </p>
      <p>
