...
import {
  type BodyPart,
  type Part,
} from "~/app/(site)/tools/sankofa-sizer/_validators/types";
    ...
    >
      ...
      >
        <div className="flex flex-col">
          <div className="flex flex-col">
            <span className="part-name relative w-20 min-w-min rounded-e-3xl bg-slate-200 px-2 py-2 font-bold whitespace-nowrap text-slate-800">
              {bodyPart.name}
            </span>
            <Input
              value={inputValue}
