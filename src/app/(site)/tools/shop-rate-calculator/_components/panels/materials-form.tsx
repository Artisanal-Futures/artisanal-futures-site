      ...
      >
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <>
            ...
            <ScrollArea className="bg-card col-span-full max-h-96 rounded-lg border p-4 shadow-sm">
              {fields.map((field, index) => (
                <section
                  key={field.id}
                  className="bg-background hover:bg-accent/10 mb-4 flex w-full flex-col gap-4 rounded-md p-6 shadow-sm transition-colors sm:col-span-full"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className="hover:bg-destructive hover:text-destructive-foreground h-10 w-10"
                    >
                            ...
                            <FormControl>
                              <div className="relative mt-2 rounded-md shadow-sm">
                                ...
                                <div className="absolute inset-y-0 right-0 flex items-center">
                                  ...
                                  >
                                    <SelectTrigger>
                                      <SelectValue className="h-full rounded-md border-0 border-transparent bg-transparent py-0 pr-7 pl-2 text-gray-500 ring-0 sm:text-sm" />
                                    </SelectTrigger>
                                    <SelectContent>
