...
-- CreateEnum
CREATE TYPE "Framework" AS ENUM ('WORDPRESS', 'NEXTJS', 'GHOST', 'STRAPI');

-- CreateEnum
CREATE TYPE "LoraType" AS ENUM ('SUBJECT', 'STYLE', 'MULTI_CONCEPT', 'REGULARIZATION', 'UNKNOWN', 'SINGLE_CONCEPT');

-- CreateEnum
CREATE TYPE "ProvisionStatus" AS ENUM ('PENDING', 'PROVISIONING', 'BUILDING', 'DEPLOYING', 'ACTIVE', 'FAILED', 'SUSPENDED', 'DELETING', 'DELETED');

-- CreateEnum
CREATE TYPE "SiteType" AS ENUM ('ECOMMERCE', 'BLOG', 'PORTFOLIO', 'LANDING_PAGE', 'BUSINESS', 'CUSTOM');

-- CreateEnum
CREATE TYPE "TrainingJobType" AS ENUM ('CAPTION_IMAGE', 'TRAIN_MODEL', 'GENERIC_JOB');

-- CreateEnum
CREATE TYPE "TrainingVisibility" AS ENUM ('PUBLIC', 'PRIVATE');
...
-- CreateEnum
CREATE TYPE "ResourceType" AS ENUM ('UPCYCLE_RESULT', 'GENERIC', 'TRAINING_RESULT', 'CHECKPOINT_TRAINING', 'CHECKPOINT_GENERATION');

-- CreateEnum
CREATE TYPE "UpcycleType" AS ENUM ('GENERATE', 'GENERATE_FROM_STRUCTURE', 'TRAIN_AND_GENERATE', 'GENERATE_ON_PRE_TRAINED', 'TRAIN_ONLY');

-- CreateEnum
CREATE TYPE "status" AS ENUM ('QUEUED', 'PROCESSING', 'SUCCEEDED', 'FAILED', 'CANCELED', 'TIMEOUT');
...
CREATE TABLE "TrainingDataSet" (
    ...
    "tags" TEXT[],
    "userId" TEXT NOT NULL,
    "setType" "LoraType" NOT NULL DEFAULT 'UNKNOWN',
    "triggerWord" TEXT NOT NULL DEFAULT 'TOK',
...
CREATE TABLE "TrainingImage" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "referenceId" TEXT,
    "imageType" "LoraType" NOT NULL DEFAULT 'UNKNOWN',
    "trainingDataSetId" TEXT,
    "isRegularization" BOOLEAN NOT NULL DEFAULT false,
    "autoCaptionUpdatedAt" TIMESTAMP(3),
    "userCaptionUpdatedAt" TIMESTAMP(3),
...
CREATE TABLE "TrainingJob" (
    "id" TEXT NOT NULL,
    "trainingModelId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "status" "status" NOT NULL DEFAULT 'QUEUED',
    "error" TEXT,
    "referenceId" TEXT,
    "type" "TrainingJobType" NOT NULL DEFAULT 'GENERIC_JOB',
...
CREATE TABLE "TrainingModel" (
    ...
    "referenceId" TEXT,
    "versionId" TEXT,
    "loraType" "LoraType" NOT NULL DEFAULT 'SUBJECT',
    "trainingSubject" TEXT NOT NULL DEFAULT 'Unknown Object',
    "description" TEXT,
    "tags" TEXT[],
    "title" TEXT,
...
CREATE TABLE "WebsiteProvision" (
    ...
    "coolifyDatabaseUuid" TEXT,
    "coolifyServiceUuid" TEXT,
    "adminPasswordEncrypted" TEXT,
    "adminUser" TEXT,

    CONSTRAINT "WebsiteProvision_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UpcycleResult" (
    ...
    "originalTrainingId" TEXT,
    "trainingCaptions" JSONB DEFAULT '{}',
    "trainingImageFilenames" JSONB,
    "trainingImageUrls" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- CreateTable
CREATE TABLE "_TrainingModelToUpcycleResult" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_TrainingModelToUpcycleResult_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_DepotToUser" (
    ...
    CONSTRAINT "_DepotToUser_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "WebsiteProvision_customDomain_key" ON "WebsiteProvision"("customDomain");

-- CreateIndex
CREATE UNIQUE INDEX "WebsiteProvision_subdomain_key" ON "WebsiteProvision"("subdomain");

-- CreateIndex
CREATE UNIQUE INDEX "WebsiteProvision_coolifyProjectUuid_key" ON "WebsiteProvision"("coolifyProjectUuid");

-- CreateIndex
CREATE UNIQUE INDEX "WebsiteProvision_shopId_key" ON "WebsiteProvision"("shopId");

-- CreateIndex
CREATE UNIQUE INDEX "WebsiteProvision_coolifyServiceUuid_key" ON "WebsiteProvision"("coolifyServiceUuid");

-- CreateIndex
CREATE INDEX "WebsiteProvision_createdAt_idx" ON "WebsiteProvision"("createdAt");

-- CreateIndex
CREATE INDEX "WebsiteProvision_deletedAt_idx" ON "WebsiteProvision"("deletedAt");

-- CreateIndex
CREATE INDEX "WebsiteProvision_framework_idx" ON "WebsiteProvision"("framework");

-- CreateIndex
CREATE INDEX "WebsiteProvision_status_idx" ON "WebsiteProvision"("status");

-- CreateIndex
CREATE INDEX "WebsiteProvision_subdomain_idx" ON "WebsiteProvision"("subdomain");

-- CreateIndex
CREATE INDEX "WebsiteProvision_userId_idx" ON "WebsiteProvision"("userId");
...
-- CreateIndex
CREATE INDEX "_TrainingModelToUpcycleResult_B_index" ON "_TrainingModelToUpcycleResult"("B");
...
-- AddForeignKey
ALTER TABLE "TrainingDataSet" ADD CONSTRAINT "TrainingDataSet_trainingModelId_fkey" FOREIGN KEY ("trainingModelId") REFERENCES "TrainingModel"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TrainingDataSet" ADD CONSTRAINT "TrainingDataSet_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TrainingImage" ADD CONSTRAINT "TrainingImage_trainingDataSetId_fkey" FOREIGN KEY ("trainingDataSetId") REFERENCES "TrainingDataSet"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TrainingImage" ADD CONSTRAINT "TrainingImage_trainingModelId_fkey" FOREIGN KEY ("trainingModelId") REFERENCES "TrainingModel"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TrainingJob" ADD CONSTRAINT "TrainingJob_trainingModelId_fkey" FOREIGN KEY ("trainingModelId") REFERENCES "TrainingModel"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WebsiteProvision" ADD CONSTRAINT "WebsiteProvision_shopId_fkey" FOREIGN KEY ("shopId") REFERENCES "Shop"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WebsiteProvision" ADD CONSTRAINT "WebsiteProvision_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_TrainingModelToUpcycleResult" ADD CONSTRAINT "_TrainingModelToUpcycleResult_A_fkey" FOREIGN KEY ("A") REFERENCES "TrainingModel"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_TrainingModelToUpcycleResult" ADD CONSTRAINT "_TrainingModelToUpcycleResult_B_fkey" FOREIGN KEY ("B") REFERENCES "UpcycleResult"("id") ON DELETE CASCADE ON UPDATE CASCADE;
