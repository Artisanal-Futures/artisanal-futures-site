...
export const categoriesWithKeywords: CategoryData[] = [
  {
    ...
    children: [
      {
        name: "Tops",
        keywords: ["shirt", "tee", "blouse", "tunic", "crop top"],
      },
      {
        name: "Bottoms",
        keywords: ["pants", "skirt", "jeans", "trousers", "shorts"],
      },
      {
        name: "Dresses & Skirts",
        keywords: ["dress", "skirt", "gown", "maxi"],
      },
      { name: "Jackets", keywords: ["jacket", "coat", "blazer", "trench"] },
      {
        name: "Jumpsuits & Bodysuits",
        keywords: ["jumpsuit", "romper", "bodysuit"],
      },
    ],
  },
  {
    ...
    children: [
      { name: "Rings", keywords: ["ring"] },
      {
        ...
        keywords: ["necklace", "pendant", "pendent"],
      },
      { name: "Earrings", keywords: ["earring", "hoops"] },
      {
        name: "Bracelets & Anklets",
        keywords: ["bracelet", "anklet", "bead", "beads"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: "Bar & Drinkware",
        keywords: ["cocktail picks", "drink garnishes", "cocktail kit"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        name: "Graphic Design",
        keywords: ["logo", "graphic design", "branding"],
      },
      {
        name: "Custom Artwork",
        keywords: ["illustration", "painting", "commission"],
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        keywords: ["pottery", "knitting", "painting class"],
      },
      {
        name: "Creative Workshops",
        keywords: ["workshop", "lesson", "course"],
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        keywords: ["interior design", "consultation"],
      },
      {
        name: "Creative Strategy",
        keywords: ["brand strategy", "creative consulting"],
      },
    ],
  },
  {
    ...
    children: [
      {
        name: "Gardening & Cultivation",
        keywords: ["mushroom cultivating", "gardening"],
      },
    ],
  },
];
